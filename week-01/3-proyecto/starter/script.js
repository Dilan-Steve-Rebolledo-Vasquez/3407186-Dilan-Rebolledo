...
console.log('=========================================');
console.log('PLATAFORMA DE FREELANCERS - FICHA #3407186');
console.log('=========================================');
console.log('');
...
console.log('Categoría:       [PLATAFORMA DE TALENTO DIGITAL]');

// TODO: Indica el estado actual de la entidad (string)
// Ejemplos: 'Disponible', 'En stock', 'Activo', 'Ocupado'
console.log('Estado de la Plataforma:          [ACTIVA]');
...
console.log('Freelancers Registrados:    500');
...
console.log('Valor calculado:    ', 60008710 * 0.5); // TODO: reemplaza 0 con tu cálculo
...
console.log('Freelancers Disponibles: ', true);

// TODO: Otro valor boolean diferente al anterior (true o false — sin comillas)
console.log('Proyecto Activo: ', false);
...
console.log('[GRACIAS POR PREFERIR A NUESTROS FREELANCERS]');
