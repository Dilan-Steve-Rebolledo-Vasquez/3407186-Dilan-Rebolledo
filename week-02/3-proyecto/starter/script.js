...
const itemCategory = "Plataforma Web";
...
const averageProjectPayment = 270000; // reemplaza 0 con el número adecuado
...
const isFreelancerAvailable = true; // reemplaza con algo de tu dominio
...
const currentProject = null; // cambia el nombre a algo de tu dominio
...
console.log(`Pago Promedio: ${averageProjectPayment}`);
console.log(`Freelancer Activo: ${isFreelancerAvailable}`)
...
console.log("typeof averageProjectPayment:     ", typeof averageProjectPayment)
